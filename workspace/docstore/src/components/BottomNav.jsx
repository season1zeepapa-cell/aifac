...
export default function BottomNav({ activeTab, onTabChange }) {
  const tabs = [
    { id: 'upload', label: '등록', icon: (
      <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
    )},
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card-bg border-t border-border z-40 shadow-sm">
      <div className="max-w-3xl mx-auto grid grid-cols-6">
        {tabs.map(tab => (
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-2 sm:py-2.5 transition-colors ${
              tab.disabled
